...
```console
$ xz -d kali-nethunterpro-2026.1-pinephone-phosh.img.xz
$ dd if=kali-nethunterpro-2026.1-pinephone-phosh.img of=/dev/mmcblkX bs=1M oflag=sync status=progress
```
...
```console
# Install on SDCard:
$ xz -d kali-nethunterpro-2026.1-sdm845.img.xz
