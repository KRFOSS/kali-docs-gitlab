...
```console
kali@kali:~$ curl -i https://cdimage.kali.org/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
HTTP/1.1 302 Found
Server: nginx
...
Link: <https://kali.download/base-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso>; rel=duplicate; pri=1; geo=ae
Link: <https://ask4.mm.fcix.net/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso>; rel=duplicate; pri=2; geo=gb
Link: <https://ftp.hands.com/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso>; rel=duplicate; pri=3; geo=gb
Location: https://mirror.vinehost.net/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
...
```console
kali@kali:~$ get https://kali.download/base-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
--2025-06-18 10:53:17--  https://kali.download/base-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
...
Saving to: ‘kali-linux-2026.1-installer-amd64.iso’

kali-linux-2026.1-installer-amd64.iso   6%[====>                                                                     ] 196.46M  31.6MB/s    eta 81s
...
Cache-Control: private, no-cache
Link: <https://kali.download/base-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso>; rel=duplicate; pri=1; geo=ae
Location: https://archive-4.kali.org/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso

kali@kali:~$ wget https://archive-4.kali.org/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
--2025-06-18 10:56:00--  https://archive-4.kali.org/kali-images/kali-2026.1/kali-linux-2026.1-installer-amd64.iso
...
kali-linux-2026.1-installer-amd64.iso   0%[                                                                          ] 615.75K   610KB/s
