...
```console
$ xzcat kali-linux-2025.2-odroid-c2-arm64.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2025.2-odroid-c2-arm64.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
