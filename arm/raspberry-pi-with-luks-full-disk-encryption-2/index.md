...
We first will [download](/get-kali/#kali-arm) the [latest stable](/releases/) Kali RPi image. At the time of writing, that's [Kali 2025.2](/blog/kali-linux-2025-2-release/).
...
# LINUX IMAGE FILE ------------------------------------------------------------
export _IMAGEURL=https://kali.download/arm-images/kali-2025.2/kali-linux-2025.2-raspberry-pi-arm64.img.xz
