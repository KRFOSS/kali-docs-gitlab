...
We first will [download](/get-kali/#kali-arm) the [latest stable](/releases/) Kali RPi image. At the time of writing, that's [Kali 2026.2](/blog/kali-linux-2026-2-release/).
...
```console
$ wget https://kali.download/arm-images/kali-2026.2/kali-linux-2026.2-raspberry-pi-arm64.img.xz
...
# LINUX IMAGE FILE ------------------------------------------------------------
export _IMAGEURL=https://kali.download/arm-images/kali-2026.2/kali-linux-2026.2-raspberry-pi-arm64.img.xz
