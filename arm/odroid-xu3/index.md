...
```console
$ xzcat kali-linux-2025.4-odroid-xu3-armhf.img.xz | sudo dd of=/dev/sdX bs=4M status=progress
```
...
```console
$ xzcat kali-linux-2025.4-odroid-xu3-armhf.img.xz | sudo dd of=/dev/mmcblk1 bs=4M status=progress
```
